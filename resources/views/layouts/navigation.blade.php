            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('path/to/your/logo.svg') }}" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" alt="Application Logo" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'text-indigo-500' : 'text-gray-500' }}">
                        {{ __('Dashboard') }}
                    </a>
                </div>
            </div>
